...
int main()
{
    ...
    // decide whether eta is set same among systems or among constraints
    //double eta[NumSys];
    ...
    // setting 2
    //eta[0] = 0.3473; eta[1] = 0.3473; eta[2] = 0.3733; eta[3] = 0.3119; eta[4] = 0.3119;
    ...
    // setting 2
    //eta[0] = 0.5979; eta[1] = 0.5979; eta[2] = 0.6316; eta[3] = 0.5520; eta[4] = 0.5520;
