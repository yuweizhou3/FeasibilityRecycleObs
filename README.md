...
We provide the folder `procedures` that contain the code for Procedure RF and the other four alternative procedures (Recycle, Restart prob, Restart sum, and Restart max). 
