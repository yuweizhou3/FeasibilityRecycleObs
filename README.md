...
2. Decide the correlation between each pair of constraints. Adjust function `read_chol_matrix()` (line 288) to incorporate the chosen correlation and the number of constraints. This function performs Cholesky decomposition so that the generated observations for different constraints yield the desired correlation. 
